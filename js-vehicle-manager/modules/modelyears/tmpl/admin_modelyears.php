...
<div id="jsvehiclemanageradmin-wrapper">
    ...
    <?php
    $msgkey = JSVEHICLEMANAGERincluder::getJSModel('modelyears')->getMessagekey();
    ...
    <span class="jsvm_js-admin-title">
        ...
        <?php JSVEHICLEMANAGERincluder::getClassesInclude('jsvehiclemanageradminsidemenu'); ?>
        <a class="jsvm_js-button-link button" href="<?php echo esc_url(admin_url('admin.php?page=jsvm_modelyears&jsvmlt=formmodelyear')); ?>"><img src="<?php echo JSVEHICLEMANAGER_PLUGIN_URL; ?>includes/images/add_icon.png" /><?php echo __('Add New','js-vehicle-manager') .' '. __('Model years','js-vehicle-manager'); ?></a>
    </span>
    <div class="jsvm_page-actions">
        <a class="jsvm_js-bulk-link button jsvm_multioperation" message="<?php echo esc_attr(JSVEHICLEMANAGERmessages::getMSelectionEMessage()); ?>" data-for="publish" data-for-wpnonce="<?php echo esc_attr(wp_create_nonce("publish-modelyear")); ?>" href="#"><img src="<?php echo JSVEHICLEMANAGER_PLUGIN_URL; ?>includes/images/publish-icon.png" /><?php echo __('Publish', 'js-vehicle-manager') ?></a>
        <a class="jsvm_js-bulk-link button jsvm_multioperation" message="<?php echo esc_attr(JSVEHICLEMANAGERmessages::getMSelectionEMessage()); ?>" data-for="unpublish" data-for-wpnonce="<?php echo esc_attr(wp_create_nonce("unpublish-modelyear")); ?>" href="#"><img src="<?php echo JSVEHICLEMANAGER_PLUGIN_URL; ?>includes/images/unbuplish.png" /><?php echo __('Unpublished', 'js-vehicle-manager') ?></a>
    ...
    <form class="jsvm_js-filter-form" name="jsvehiclemanagerform" id="jsvehiclemanagerform" method="post" action="<?php echo esc_url(admin_url("admin.php?page=jsvm_modelyears")); ?>">
    ...
    if (!empty(jsvehiclemanager::$_data[0])) {
        ?>
        <form id="jsvehiclemanager-list-form" method="post" action="<?php echo esc_url(admin_url("admin.php?page=jsvm_modelyears")); ?>">
                    ...
                    for ($i = 0, $n = count(jsvehiclemanager::$_data[0]); $i < $n; $i++) {
                        ...
                        <tr valign="top">
                            ...
                            <td class="jsvm_left-row">
                                <a href="<?php echo esc_url(admin_url('admin.php?page=jsvm_modelyears&jsvmlt=formmodelyear&jsvehiclemanagerid='.$row->id)); ?>">
                                    <?php echo __($row->title,'js-vehicle-manager'); ?></a>
                            </td>
                            <td>
                                <?php if ($row->status == 1) { ?>
                                    <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=jsvm_modelyears&task=unpublish&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id.$pageid),'unpublish-modelyear')); ?>">
                                ...
                                <?php } else { ?>
                                    <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=jsvm_modelyears&task=publish&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id.$pageid),'publish-modelyear')); ?>">
                            ...
                            <td>
                                ...
                                <?php } else { ?>
                                    <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=jsvm_common&task=makedefault&action=jsvmtask&for=modelyears&id='.$row->id.$pageid.'&jsvmlt=modelyears'),'make-default')); ?>">
                            ...
                            <td>
                                <?php if ($i != 0 || $pagenum > 1) { ?>
                                    <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=jsvm_common&task=defaultorderingup&action=jsvmtask&for=modelyears&id='.$row->id.$pageid.'&jsvmlt=modelyears'),'field-up')); ?>">
                                ...
                                <?php if ($i < $n - 1 || $islastordershow) { ?>
                                    <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=jsvm_common&task=defaultorderingdown&action=jsvmtask&for=modelyears&id='.$row->id.$pageid.'&jsvmlt=modelyears'),'field-down')); ?>">
                            ...
                            <td class="jsvm_action">
                                <a href="<?php echo esc_url(admin_url('admin.php?page=jsvm_modelyears&jsvmlt=formmodelyear&jsvehiclemanagerid='.$row->id)); ?>"><img src="<?php echo JSVEHICLEMANAGER_PLUGIN_URL; ?>includes/images/edit.png" title="<?php echo __('Edit', 'js-vehicle-manager'); ?>"></a>
                                <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=jsvm_modelyears&task=remove&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id),'delete-modelyear')); ?>" onclick="return confirmdelete('<?php echo __('Are you sure to delete', 'js-vehicle-manager').' ?'; ?>');"><img src="<?php echo JSVEHICLEMANAGER_PLUGIN_URL; ?>includes/images/remove.png" title="<?php echo __('Delete', 'js-vehicle-manager'); ?>"></a>
                            </td>
                        </tr>
                <?php
                    }
            ...
            <?php echo wp_kses(JSVEHICLEMANAGERformfield::hidden('_wpnonce', wp_create_nonce('delete-modelyear')), JSVEHICLEMANAGER_ALLOWED_TAGS); ?>
        </form>
        <?php
        ...
        $link[] = array(
                    'link' => 'admin.php?page=jsvm_modelyears&jsvmlt=formmodelyear',
                    'text' => __('Add New','js-vehicle-manager') .' '. __('Model Year','js-vehicle-manager')
                );
